    ...
    return queryInterface.bulkInsert('Businesses', [
      {
        ...
        description:
          'Expect a laid back neighborhood feel. They’ve got a nice patio space for warm weather days.',
        stillExists: true,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description:
          'This female-owned brewery specializes in well-loved styles of beer whose clever names pay homage to "Bold Missies" that have shaped history.',
        stillExists: true,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description:
          'Catawba’s easy-drinking beer and patio with a skyline view makes the new 10,000-square-foot taproom a weekend must',
        stillExists: true,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      ...
      },
      {
        ...
        description:
          'Think industrial meets old pub. Heist is no frills, just good food and beer.',
        stillExists: true,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description:
          'Legion’s OG location in Plaza has a cozy, neighborhood vibe.',
        stillExists: true,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description:
          'In addition to beer, they also have craft spiked seltzer on tap.',
        stillExists: true,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description:
          'There’s no flagship or signature beer, as all batches are small and experimental. They call themselves a nano-brewery.',
        stillExists: true,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description:
          'Head brewer, Jeremy Claeys comes to Protagonist from Asheville’s Wicked Weed Brewing.',
        stillExists: true,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description:
          'The brewery specializes in hop-forward IPAs and pale ales, lagers, barrel-aged beers and fermented ales.',
        stillExists: true,
        createdAt: new Date(),
        updatedAt: new Date()
      },
